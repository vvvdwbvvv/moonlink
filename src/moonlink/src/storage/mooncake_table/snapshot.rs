...
impl SnapshotTableState {
    pub(super) async fn new(
        ...
        Ok(Self {
            ...
            unpersisted_iceberg_records: UnpersistedIcebergSnapshotRecords {
                ...
                compacted_data_files_to_add: Vec::new(),
                compacted_data_files_to_remove: Vec::new(),
                compacted_file_indices_to_add: Vec::new(),
    ...
    pub(super) async fn update_snapshot(
        ...
        self.prune_persisted_compacted_data(
            &task.iceberg_persisted_old_compacted_data_files,
            &task.iceberg_persisted_new_compacted_data_files,
            &task.iceberg_persisted_old_compacted_file_indices,
            &task.iceberg_persisted_new_compacted_file_indices,
        );
