...
Moonlink supports multiple input sources through [moonlink-connectors](https://github.com/Mooncake-Labs/moonlink/tree/main/src/moonlink_connectors). Currently, Postgres logical replication is the only supported source, built on the great foundation of Supabase's [etl](https://github.com/supabase/etl) project.

## Sample Usage
Today, Moonlink can be used as a Rust library. The **[pg_mooncake](https://github.com/Mooncake-Labs/pg_mooncake/)** Postgres extension runs Moonlink as a background worker process that:
